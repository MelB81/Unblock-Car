...
class Voiture:
    ...
    def bouger(self, x, y):
        ...
        for v in listeVoiture: #pb dans les conditions, à reprendre
            if v != self:
...
dessin.create_line(sx0 + cote/18, sy0 + cote/12, sx0 + cote/6 - cote/18, sy0 + cote/12, width=5, arrow='first')
