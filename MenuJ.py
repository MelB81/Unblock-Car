...
class MenuJ:  # on ne l'appelle pas Menu car cette classe existe déjà, et on aurait des messages d'erreur sinon
    ...
    def niveau(self):
        ...
        # lancer la musique 
        self.musique=Musique(self.canva,self.largeur - 250, 50)
        ...
        self.time=Timer(self.plateau.canva, self.plateau.debut / 4, 25, self.plateau.debut + self.plateau.cote / 2, self.hauteur / 7)
